...
public class LogLogPlotHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = SaxsPlotsSourceProvider.LOGLOG_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.loglogplot.state";
