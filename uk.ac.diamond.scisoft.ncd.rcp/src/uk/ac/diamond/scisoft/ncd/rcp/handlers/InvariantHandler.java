...
public class InvariantHandler extends AbstractHandler implements
	...
	public static String COMMAND_ID = NcdProcessingSourceProvider.INVARIANT_STATE;
	public static String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.invariant.state";
