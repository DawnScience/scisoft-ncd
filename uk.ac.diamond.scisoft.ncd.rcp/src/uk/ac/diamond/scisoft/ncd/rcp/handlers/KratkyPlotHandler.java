...
public class KratkyPlotHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = SaxsPlotsSourceProvider.KRATKY_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.kratkyplot.state";
