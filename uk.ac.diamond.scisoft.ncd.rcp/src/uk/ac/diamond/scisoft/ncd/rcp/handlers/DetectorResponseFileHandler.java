...
public class DetectorResponseFileHandler extends AbstractHandler {
	...
	private static final Logger logger = LoggerFactory.getLogger(DetectorResponseFileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		NcdProcessingSourceProvider ncdDrFileSourceProvider = (NcdProcessingSourceProvider) service
				.getSourceProvider(NcdProcessingSourceProvider.DRFILE_STATE);
