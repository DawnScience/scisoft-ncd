...
public class PorodPlotHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = SaxsPlotsSourceProvider.POROD_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.porodplot.state";
