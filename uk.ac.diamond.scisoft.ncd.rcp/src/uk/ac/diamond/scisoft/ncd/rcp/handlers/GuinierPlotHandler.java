...
public class GuinierPlotHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = SaxsPlotsSourceProvider.GUINIER_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.guinierplot.state";
