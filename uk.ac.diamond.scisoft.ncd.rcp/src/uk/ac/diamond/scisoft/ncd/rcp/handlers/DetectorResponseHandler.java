...
public class DetectorResponseHandler extends AbstractHandler implements
	...
	public static String COMMAND_ID = NcdProcessingSourceProvider.RESPONSE_STATE;
	public static String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.detectorresponse.state";
