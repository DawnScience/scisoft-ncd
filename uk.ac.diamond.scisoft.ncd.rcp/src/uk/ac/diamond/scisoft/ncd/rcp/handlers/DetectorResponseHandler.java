...
public class DetectorResponseHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = NcdProcessingSourceProvider.RESPONSE_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.detectorresponse.state";
