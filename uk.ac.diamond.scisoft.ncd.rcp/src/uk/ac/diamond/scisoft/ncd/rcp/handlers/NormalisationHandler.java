...
public class NormalisationHandler extends AbstractHandler implements
	...
	public static String COMMAND_ID = NcdProcessingSourceProvider.NORMALISATION_STATE;
	public static String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.normalisation.state";
