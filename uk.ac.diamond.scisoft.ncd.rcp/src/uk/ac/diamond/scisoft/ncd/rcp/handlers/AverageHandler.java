...
public class AverageHandler extends AbstractHandler implements IElementUpdater {

	public static final String COMMAND_ID = NcdProcessingSourceProvider.AVERAGE_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.average.state";
