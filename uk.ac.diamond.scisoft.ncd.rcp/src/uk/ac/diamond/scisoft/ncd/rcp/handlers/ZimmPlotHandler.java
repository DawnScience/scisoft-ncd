...
public class ZimmPlotHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = SaxsPlotsSourceProvider.ZIMM_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.zimmplot.state";
