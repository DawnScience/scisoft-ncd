...
public class SectorIntegrationHandler extends AbstractHandler implements
	...
	public static String COMMAND_ID = NcdProcessingSourceProvider.SECTOR_STATE;
	public static String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.sectorintegration.state";
