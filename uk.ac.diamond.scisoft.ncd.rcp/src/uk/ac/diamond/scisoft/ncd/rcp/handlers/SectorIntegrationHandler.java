...
public class SectorIntegrationHandler extends AbstractHandler implements
		IElementUpdater {

	public static final String COMMAND_ID = NcdProcessingSourceProvider.SECTOR_STATE;
	public static final String STATE_ID = "uk.ac.diamond.scisoft.ncd.rcp.sectorintegration.state";
