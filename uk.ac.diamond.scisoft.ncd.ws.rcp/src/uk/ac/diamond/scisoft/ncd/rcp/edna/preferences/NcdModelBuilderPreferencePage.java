...
public class NcdModelBuilderPreferencePage  extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	
	public NcdModelBuilderPreferencePage() {
		super(GRID);
	...
	public void init(IWorkbench workbench) {
		...
		setDescription("Parameters used in NCD Model Building");
	}
	...
	protected void createFieldEditors() {
		...
		g.setText("Model builder preference settings");
		{
			...
			addField(new BooleanFieldEditor(NcdPreferences.NCD_ALLOWSELECTIONOFPATHS, "Allow user to select Nexus q and data paths", gc));
		}
